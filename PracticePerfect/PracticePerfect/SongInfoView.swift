...
struct SongInfoView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        SongInfoView(songMetadata: SongMetadata(id: -1, name: "", artist: "", resourceUrl: "", year: -1, level: -1, topScore: -1, highScore: -1, highScoreId: -1, deleted: false, rank: "")).previewLayout(.fixed(width: 896, height: 414))
    }
}
