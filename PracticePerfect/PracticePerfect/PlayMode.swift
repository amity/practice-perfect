                ...
                HStack {
                    ...
                    .simultaneousGesture(TapGesture().onEnded {
                        ...
                        if self.songMetadata.highScoreId == -1 {
                            postNewScore(songId: self.songMetadata.id, score: Int(self.runningScore))
                        } else {
...
struct PlayMode_Previews: PreviewProvider {
    static var previews: some View {
        ...
        PlayMode(songMetadata: SongMetadata(id: -1, name: "", artist: "", resourceUrl: "", year: -1, level: -1, topScore: -1, highScore: -1, highScoreId: -1, deleted: false, rank: ""), tempo: 120, timeSig: (4, 4)).previewLayout(.fixed(width: 896, height: 414))
    }
}
